...
public class CountryDao extends AbstractDao<Country, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property CountryId = new Property(1, Integer.class, "countryId", false, "COUNTRY_ID");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'COUNTRY' (" + //
                ...
                "'COUNTRY_ID' INTEGER," + // 1: countryId
    ...
    public Country readEntity(Cursor cursor, int offset) {
        Country entity = new Country( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1), // countryId
    ...
    public void readEntity(Cursor cursor, Country entity, int offset) {
        ...
        entity.setCountryId(cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1));
