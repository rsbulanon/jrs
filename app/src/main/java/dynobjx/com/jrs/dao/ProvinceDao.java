...
public class ProvinceDao extends AbstractDao<Province, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ProvinceId = new Property(1, Integer.class, "provinceId", false, "PROVINCE_ID");
    ...
    public Province readEntity(Cursor cursor, int offset) {
        Province entity = new Province( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1), // provinceId
    ...
    public void readEntity(Cursor cursor, Province entity, int offset) {
        ...
        entity.setProvinceId(cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1));
